...
Login an existing or new user into Open Monero.
...
Gets the list of all txs for the given user, with their possible spendings.
...
Submit raw tx in hex generated by the fronted.
...
Free import of wallet based on recent blocks (e.g., 10000 last blocks)
